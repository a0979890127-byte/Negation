...
"""
    Loki module for BEFORE_NO_NEGATION
...
INTENT_NAME = "BEFORE_NO_NEGATION"
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "李小姐結婚以前，他是絕對不會生小孩的":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("他來以前我就走了", "他來以前我就走了", [], {}, {})
    pprint(resultDICT)