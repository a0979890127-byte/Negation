...
def testIntent():
    ...
    # NEG_BEFORE_EXPLETIVE_MEI
    print("[TEST] NEG_BEFORE_EXPLETIVE_MEI")
    inputLIST = ['他沒來以前我就走了','炸彈沒爆炸以前，就被拆除了','醫生還沒來以前，張三就死了','張三沒上大學以前，他就已經很懂事了','李小姐沒結婚以前，他是絕對不會生小孩的']
    testLoki(inputLIST, ['NEG_BEFORE_EXPLETIVE_MEI'])
    print("")

    # BEFORE_NO_NEGATION
    print("[TEST] BEFORE_NO_NEGATION")
    inputLIST = ['他來以前我就走了','醫生來以前，張三就死了','炸彈爆炸以前，就被拆除了','張三上大學以前，他就已經很懂事了','李小姐結婚以前，他是絕對不會生小孩的']
    testLoki(inputLIST, ['BEFORE_NO_NEGATION'])
    print("")
